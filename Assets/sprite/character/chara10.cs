...
public class chara10 : MonoBehaviour {
	...
	void Start () {
		...
		//攻撃力＆HPステータスをリセット
		attack_type_bull.add_chara10 = 0;
		defense_add_count.add_chara10 = 0;
			...
			if (Physics.Raycast(ray, out hit)){
				...
				if(obj.name == "chara10"){
					if(change_flag == 0 && chara_count.count < 4){
						...
						//attackに加算
						attack_type_bull.add_chara10 = attack;
						Debug.Log("attack_add : " + attack_type_bull.add_chara10);
						
						//defenseに加算
						defense_add_count.add_chara10 = defense;
						Debug.Log("life_add : " + defense_add_count.add_chara10);
