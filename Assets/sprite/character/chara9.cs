...
public class chara9 : MonoBehaviour {
	...
	void Start () {
		...
		//攻撃力＆HPステータスをリセット
		attack_type_red.add_chara9 = 0;
		defense_add_count.add_chara9 = 0;
			...
			if (Physics.Raycast(ray, out hit)){
				...
				if(obj.name == "chara9"){
					if(change_flag == 0 && chara_count.count < 4){
						...
						//attackに加算
						attack_type_red.add_chara9 = attack;
						Debug.Log("attack_add : " + attack_type_red.add_chara9);
						
						//defenseに加算
						defense_add_count.add_chara9 = defense;
						Debug.Log("life_add : " + defense_add_count.add_chara9);
