...
public class chara5 : MonoBehaviour {
			...
			if (Physics.Raycast(ray, out hit)){
				...
				if(obj.name == "chara5"){
					if(change_flag == 0 && chara_count.count < 4){
						...
						//attackに加算
						attack_type_red.add_chara5 = attack;
						Debug.Log("attack_add : " + attack_type_red.add_chara5);
						
						//defenseに加算
						defense_add_count.add_chara5 = defense;
						Debug.Log("life_add : " + defense_add_count.add_chara5);
						...
						//attackに減算
						attack_type_red.add_chara5 = 0;
						
						//defenseに減算
						defense_add_count.add_chara5 = 0;
					} 
				}
				Debug.Log(obj.name);
			}
